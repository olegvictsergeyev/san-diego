...
Агент смещает персонажа по соответствующей оси на `value` студий с промежуточными телепортами (X/Z — 20 студий за шаг, Y — 100 студий за шаг), чтобы избежать анти-чита.
...
Агент устанавливает `Humanoid.Health = 0`, что вызывает респавн.
